...
extern taco_section *
taco_section_create2_(taco_allocator *alloc) TACO_MALLOC;
extern taco_section *
...
extern taco_event *taco_section_locate_mut_(taco_section *restrict s,
                                              size_t i);
...
#define taco_section_foreach_mut_(i, s)                                       \
  for (taco_event *i = taco_section_begin_mut_(s);                           \
       i != taco_section_end(s); i = taco_event_next_mut_(i))
